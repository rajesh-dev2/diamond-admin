...
const COLUMNS: ColumnDef<any>[] = [
  { key: 'date', header: 'Date', width: '79px' },
  { key: 'credit', header: 'Credit', width: '79px', align: 'right' },
  { key: 'debit', header: 'Debit', width: '79px', align: 'right' },
  { key: 'closing', header: 'Closing', width: '79px', align: 'right' },
